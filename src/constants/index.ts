...
export const UI_TEXT = {
  ...
  /** Compact calendar cell count (mobile); full word stays for a11y via aria-label. */
  CALENDAR_TX_COUNT_SHORT: "{count}",
  CALENDAR_WEEKDAYS_NARROW: ["S", "M", "T", "W", "T", "F", "S"],
  DEPOSITS: "Deposits",
  ...
  IMPORT_TOO_LARGE:
    "Too many rows selected ({count}). Import at most {max} at a time to stay within free-tier write limits.",
  ...
  ADMIN_USERS_SUBTITLE: "View app users, roles, and account status.",
  ADMIN_USERS_SEARCH_PLACEHOLDER: "Search by email, name, or UID…",
  ADMIN_USERS_EMPTY_TITLE: "No users found",
  ADMIN_USERS_EMPTY_DESCRIPTION: "Try a different search, or check Firebase Auth.",
  ADMIN_USERS_LOAD_MORE: "Load more",
  ADMIN_USERS_TRUNCATED: "Search stopped after scanning the maximum number of accounts. Narrow your query.",
  ADMIN_ROLE_ADMIN: "Admin",
  ADMIN_ROLE_USER: "User",
  ADMIN_STATUS_ACTIVE: "Active",
  ADMIN_STATUS_DISABLED: "Disabled",
  ADMIN_CREATED_AT: "Joined",
  ADMIN_LAST_SIGN_IN: "Last sign-in",
  ADMIN_NEVER_SIGNED_IN: "Never",
  ADMIN_PROMOTE: "Make admin",
  ADMIN_DEMOTE: "Remove admin",
  ADMIN_DISABLE: "Disable account",
  ADMIN_ENABLE: "Enable account",
  ADMIN_DELETE: "Delete user",
  ADMIN_PROMOTE_CONFIRM_TITLE: "Promote to admin?",
  ADMIN_PROMOTE_CONFIRM_MESSAGE: "This user will be able to open Admin and manage other accounts.",
  ADMIN_DEMOTE_CONFIRM_TITLE: "Remove admin access?",
  ADMIN_DEMOTE_CONFIRM_MESSAGE: "This user will lose access to the Admin area.",
  ADMIN_DISABLE_CONFIRM_TITLE: "Disable this account?",
  ADMIN_DISABLE_CONFIRM_MESSAGE:
    "They will not be able to sign in until you enable the account again. Their expense data is kept.",
  ADMIN_ENABLE_CONFIRM_TITLE: "Enable this account?",
  ADMIN_ENABLE_CONFIRM_MESSAGE: "They will be able to sign in again.",
  ADMIN_DELETE_CONFIRM_TITLE: "Delete this user permanently?",
  ADMIN_DELETE_CONFIRM_MESSAGE:
    "This removes their Firebase Auth account so they can no longer sign in. Firestore expense data for this user is not deleted and may remain orphaned.",
  ADMIN_ACTION_SUCCESS_PROMOTED: "User promoted to admin.",
  ADMIN_ACTION_SUCCESS_DEMOTED: "Admin access removed.",
  ADMIN_ACTION_SUCCESS_DISABLED: "Account disabled.",
  ADMIN_ACTION_SUCCESS_ENABLED: "Account enabled.",
  ADMIN_ACTION_SUCCESS_DELETED: "User deleted.",
  TOAST_FALLBACK_SUCCESS: "Done",
  TOAST_FALLBACK_ERROR: "Something went wrong",
  TOAST_FALLBACK_WARNING: "Warning",
  TOAST_FALLBACK_INFO: "Info",
  ADMIN_ACCESS_DENIED_TITLE: "Admin access required",
  ADMIN_ACCESS_DENIED_DESCRIPTION: "This area is only available to platform admins.",
  ADMIN_DELETE_DATA_NOTE:
    "Deleting a user removes their Auth account only. Their Firestore data may remain until cleaned up separately.",
  SPLIT_EXPENSES: "Split Expenses",
  TAX_DEDUCTIBLE: "Tax Deductible",
  SHARED_EXPENSE: "Shared Expense",
  ROLLOVER_BUDGET: "Rollover Budget",
  SUBSCRIPTION_ALERTS: "Subscription Alerts",
  ASK_BUDGETY: "Ask Budgety",
  TAX_EXPORT: "Tax Export",

  // Debt screen
  DEBT_TRACKER: "Debt Tracker",
  DEBT_TRACKER_SUBTITLE: "Track and eliminate your debts strategically.",
  ADD_DEBT: "Add Debt",
  EDIT_DEBT: "Edit Debt",
  DELETE_DEBT_TITLE: "Delete Debt",
  CONFIRM_DELETE_DEBT: "Are you sure you want to delete this debt?",
  DEBT_TITLE: "Debt Name",
  DEBT_KIND: "Type",
  DEBT_BALANCE: "Current Balance",
  DEBT_PRINCIPAL: "Original Principal",
  DEBT_INTEREST_RATE: "Interest Rate (%)",
  DEBT_MINIMUM_PAYMENT: "Minimum Monthly Payment",
  DEBT_DUE_DAY: "Due Day (optional)",
  NO_DEBTS: "No debts tracked. Add your first debt to get started!",
  ...
  SPLIT_TRACKER_SUBTITLE: "Track shared expenses and settle balances.",
  ADD_PARTICIPANT: "Add Participant",
  PARTICIPANT_NAME: "Participant Name",
  NO_PARTICIPANTS: "No participants yet. Add people to split expenses with.",
  ADD_SPLIT_EXPENSE: "Add Shared Expense",
  EDIT_SPLIT_EXPENSE: "Edit Shared Expense",
  DELETE_SPLIT_EXPENSE_TITLE: "Delete Shared Expense",
  CONFIRM_DELETE_SPLIT_EXPENSE: "Are you sure you want to delete this shared expense?",
  SPLIT_EXPENSE_TITLE: "Expense Title",
  PAID_BY: "Paid By",
  SPLIT_PARTICIPANTS: "Split Between",
  MARK_SETTLED: "Mark Settled",
  MARK_UNSETTLED: "Mark Unsettled",
  NO_SPLIT_EXPENSES: "No shared expenses yet. Log your first split expense!",
  ...
  UNSETTLED: "Active",
  YOU_PARTICIPANT: "You",
  SUCCESS_PARTICIPANT_ADDED: "Participant added!",
  SUCCESS_PARTICIPANT_DELETED: "Participant removed",
  SUCCESS_SPLIT_EXPENSE_ADDED: "Shared expense added!",
  SUCCESS_SPLIT_EXPENSE_UPDATED: "Shared expense updated!",
  SUCCESS_SPLIT_EXPENSE_DELETED: "Shared expense deleted",
  SUCCESS_SPLIT_SETTLED: "Expense marked as settled",
  SUCCESS_SPLIT_UNSETTLED: "Expense marked as active",

  // Rules screen
  RULES_TITLE: "Auto-Categorization Rules",
  RULES_SUBTITLE: "Create IF/THEN rules to automatically categorize new transactions.",
  ADD_RULE: "Add Rule",
  EDIT_RULE: "Edit Rule",
  ...
  NO_RULES: "No rules yet. Create your first auto-categorization rule!",
  NO_RULES_HINT: "Rules automatically assign categories to new transactions whose title contains the specified text.",
  RULE_TYPE_ANY: "Any",
  RULE_TYPE_INCOME: "Income",
  RULE_TYPE_EXPENSE: "Expense",
  ...
  APPLY_RULE: "Run",
  APPLY_RULE_ARIA: "Run this rule on existing transactions",
  APPLY_RULE_RUNNING: "Running…",
  APPLY_RULE_SUCCESS: "Updated {count} transactions with this rule.",
  APPLY_RULE_NONE: "No transactions matched this rule.",
  APPLY_RULE_INACTIVE: "Activate this rule before running it.",
  APPLY_RULES_TO_EXISTING: "Apply all to existing transactions",
  APPLY_RULES_RUNNING: "Applying rules…",
  APPLY_RULES_SUCCESS: "Updated {count} transactions with your rules.",
  APPLY_RULES_NONE: "No transactions matched your active rules.",
  APPLY_RULES_NO_ACTIVE: "Turn on at least one active rule first.",
  RULES_APPLY_HINT:
    "Rules auto-run on import and new transactions. Use Run on a rule to update past rows after you add or change it.",
...
export const ERROR_MESSAGES = {
  ...
  ADMIN_SDK_NOT_CONFIGURED:
    "Admin is not configured. Set FIREBASE_ADMIN_* credentials (and ADMIN_UIDS for the first admin) on the server.",
  ADMIN_UNAUTHORIZED: "Sign in again to manage users.",
  ADMIN_FORBIDDEN: "You do not have permission to manage users.",
  ADMIN_REQUEST_FAILED: "Could not complete the admin request. Please try again.",
  ADMIN_INVALID_BODY: "Invalid admin request.",
  ADMIN_SELF_MODIFY_BLOCKED: "You cannot disable, demote, or delete your own account.",
  ADMIN_ALLOWLIST_DEMOTE_BLOCKED:
    "This user is listed in ADMIN_UIDS. Remove their UID from the server env to demote them.",
  ADMIN_ALLOWLIST_DELETE_BLOCKED:
    "This user is listed in ADMIN_UIDS. Remove their UID from the server env before deleting them.",
  ADMIN_USER_NOT_FOUND: "That user was not found in Firebase Auth.",
};
