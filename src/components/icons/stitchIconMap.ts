...
import { ElectricBoltIcon } from "./ElectricBoltIcon";
...
import { HealthAndSafetyIcon } from "./HealthAndSafetyIcon";
...
import { QueryStatsIcon } from "./QueryStatsIcon";
...
/** Stitch Material Symbol snake_case name → React SVG component */
export const STITCH_ICONS: Record<string, IconComponent> = {
  ...
  bolt: BoltIcon,
  calendar_clock: CalendarClockIcon,
  ...
  edit: EditIcon,
  electric_bolt: ElectricBoltIcon,
  error: ErrorIcon,
