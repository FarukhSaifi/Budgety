...
/**
 * MUI theme: palette, typography, and shadows only.
 * Use Tailwind CSS classes (className) on MUI components for layout, spacing, and visual styling.
 */
export const theme = createTheme({
  ...
  shadows: [
    ...
    "0 25px 50px -12px rgba(0, 0, 0, 0.25)", // shadows[24] for Paper elevation={24}
  ],
  components: {
    MuiButton: {
      defaultProps: {
